-- B) Daily features 2019
CREATE OR REPLACE TABLE `stocks-gdelt.gdelt_analysis.gdelt_company_features_daily_2019`
PARTITION BY observation_date
CLUSTER BY ticker AS
WITH ev AS (SELECT * FROM `stocks-gdelt.gdelt_analysis.gdelt_events_2019`), -- Uses the table from Step 1
code_hits AS (
