-- 2) Daily features 2022
CREATE OR REPLACE TABLE `stocks-gdelt.gdelt_analysis.gdelt_company_features_daily_2022`
PARTITION BY observation_date
CLUSTER BY ticker AS
WITH ev AS (SELECT * FROM `stocks-gdelt.gdelt_analysis.gdelt_events_2022`), 
code_hits AS (
