-- 2) Daily features 2024
CREATE OR REPLACE TABLE `stocks-gdelt.gdelt_analysis.gdelt_company_features_daily_2024`
PARTITION BY observation_date
CLUSTER BY ticker AS
WITH ev AS (SELECT * FROM `stocks-gdelt.gdelt_analysis.gdelt_events_2024`), 
code_hits AS (
