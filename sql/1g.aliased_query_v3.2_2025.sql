-- 2) Daily features 2025
CREATE OR REPLACE TABLE `stocks-gdelt.gdelt_analysis.gdelt_company_features_daily_2025`
PARTITION BY observation_date
CLUSTER BY ticker AS
WITH ev AS (SELECT * FROM `stocks-gdelt.gdelt_analysis.gdelt_events_2025`), 
code_hits AS (
